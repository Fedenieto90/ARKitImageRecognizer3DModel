...
class ViewController: UIViewController {
    ...
    lazy var homerNode: SCNNode = {
        guard let scene = SCNScene(named: "homer.scn"),
        let node = scene.rootNode.childNode(withName: "homer", recursively: false) else { return SCNNode() }
